...
// import BookingForm from "../../../src/components/BookingForm"; // Import the booking form
...
// const VenueDetails = () => {
//   const params = useParams(); // ✅ Correctly extract dynamic route params
//   const searchParams = useSearchParams(); // ✅ Ensure this is imported
//   const id = params?.id; // TypeScript Fix
...
//     );
//   }
//   const selectedDate = searchParams.get("date") || "No date selected";
...
//           selectedDate={selectedDate} // ✅ Now passing selectedDate correctly
//           closeForm={() => setBookingOpen(false)} />
//       )}
//     </div>
//   );
// };
...
//   // ✅ Use state for selectedDate to allow updates when URL changes
...
//         <p>{venue.description}</p>
//         <p><strong>Location:</strong> {venue.location}</p>
//         <p><strong>Available Date:</strong> {selectedDate}</p> {/* ✅ FIXED */}
//         <p><strong>Available Slot:</strong> {venue.availableSlot}</p>
//         <p><strong>Pricing:</strong> {venue.pricing}</p>
//         <p><strong>Capacity:</strong> {venue.capacity}</p>
//         <p><strong>Amenities:</strong> {venue.amenities}</p>
